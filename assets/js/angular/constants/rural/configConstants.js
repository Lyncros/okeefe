(function () {
    angular.module('okeefeRuralSite.constants', [])
    //.constant('API_CLIENT_AUTH', 'http://localhost:8080/api/')
        ...
        .constant('SITE_URL', 'http://sitio.okeefe.com.ar/rural/#/')
        //.constant('SITE_URL', 'http://localhost:8080/Lyncros/Okeefe/okeefe/rural/#/')
