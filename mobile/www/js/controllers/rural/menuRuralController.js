angular.module('starter.controllers')
    .controller('menuRuralController',function ($scope, $rootScope, $auth, entitiesService, $ionicSideMenuDelegate) {
      ...
      $rootScope.$on('$stateChangeStart',
        function (event, toState, toParams, fromState, fromParams) {
          $scope.filterProperties = toState.name == 'rural.properties';
        });
      ...
      $scope.addFilter = function (filter, value, applied) {
        ...
        return window.location = entitiesService.applyFilter(filter, $scope.appliedFilters, $scope.param.tipo, $scope.param.oper, $scope.param.ubicacion, '',true);
      };
